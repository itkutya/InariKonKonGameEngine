...
namespace ikk
{
    LogicalDevice::LogicalDevice(Instance& instance, PhysicalDevice& physicalDevice, Surface& surface) noexcept
    {
    ...
    void LogicalDevice::createQueueIndices(PhysicalDevice& physicalDevice, Surface& surface)
    {
        ...
        vkGetPhysicalDeviceQueueFamilyProperties(physicalDevice.getUnderlyingVkType(), &deviceQueueFamilyPropertyCount, nullptr);
        std::vector<VkQueueFamilyProperties> deviceQueueFamilyProperties{ deviceQueueFamilyPropertyCount };
        vkGetPhysicalDeviceQueueFamilyProperties(physicalDevice.getUnderlyingVkType(), &deviceQueueFamilyPropertyCount, deviceQueueFamilyProperties.data());
        ...
        for (std::uint32_t i = 0; i < deviceQueueFamilyPropertyCount; ++i)
        {
            ...
            vkGetPhysicalDeviceSurfaceSupportKHR(physicalDevice.getUnderlyingVkType(), i, surface.getUnderlyingVkType(), &presentSupport);
    ...
    void LogicalDevice::createLogicalDevice(Instance& instance, PhysicalDevice& physicalDevice) noexcept
    {
        ...
        createInfo.enabledExtensionCount = U32(physicalDevice.getDeviceEstensions().size());
